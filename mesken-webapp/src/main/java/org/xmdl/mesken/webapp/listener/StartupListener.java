...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            if (ctx.containsBean("passwordEncoder")) {
                ...
                config.put(MeskenConstants.ENCRYPT_PASSWORD, Boolean.TRUE);
                String algorithm = "SHA";
                if (ctx.getBean("passwordEncoder") instanceof Md5PasswordEncoder) {
                    algorithm = "MD5";
                }
                config.put(MeskenConstants.ENC_ALGORITHM, algorithm);
            }
        ...
        if (log.isDebugEnabled()) {
            ...
            if (encryptPassword) {
                log.debug("Encryption Algorithm: " + config.get(MeskenConstants.ENC_ALGORITHM));
            }
    ...
    public static void setupContext(ServletContext context) {
        ...
        context.setAttribute(MeskenConstants.AVAILABLE_ROLES, mgr.getAllRoles());
