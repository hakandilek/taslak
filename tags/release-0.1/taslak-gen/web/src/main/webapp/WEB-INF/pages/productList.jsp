...
<s:form id="productsForm" namespace="/Product" action="products">
    ...
    <s:textfield key="productSearch.priceMin" cssClass="text medium" labelposition="left"/>
    <s:textfield key="productSearch.priceMax" cssClass="text medium" labelposition="left"/>
