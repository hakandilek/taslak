...
import org.xmdl.ida.lib.web.filter.LocaleFilter;
...
public class LocaleFilterTest extends TestCase {
    ...
    public void testSetLocaleInSessionWhenSessionIsNull() throws Exception {
        ...
        assertNull(request.getSession().getAttribute(BaseConstants.PREFERRED_LOCALE_KEY));
    ...
    public void testSetLocaleInSessionWhenSessionNotNull() throws Exception {
        ...
        Locale locale = (Locale) request.getSession().getAttribute(BaseConstants.PREFERRED_LOCALE_KEY);
    ...
    public void testSetInvalidLocale() throws Exception {
        ...
        assertNotNull(request.getSession().getAttribute(BaseConstants.PREFERRED_LOCALE_KEY));
    }
