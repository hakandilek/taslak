...
<s:form id="profilesForm" namespace="/Profile" action="profiles">
    <s:textfield key="profileSearch.name" cssClass="text medium" labelposition="left"/>
    <s:textfield key="profileSearch.fromPrice" cssClass="text medium" labelposition="left"/>
    <s:textfield key="profileSearch.toPrice" cssClass="text medium" labelposition="left"/>
    <s:select name="profileTypeIds" value="profileSearch.profileType.value" listKey="value" key="profile.profileType"
              list="profileTypes" labelposition="left" headerKey="-1" headerValue="*"/>
...
<s:form id="profilesList" namespace="/Profile" action="profiles">
    <display:table name="profiles" class="table" requestURI="" id="profileList" export="true" pagesize="25"
        ...
        <display:column property="name" sortable="true" titleKey="profile.name"/>
        <display:column property="price" sortable="true" titleKey="profile.price"/>
        <display:column property="profileType" sortable="true" titleKey="profile.profileType"/>
